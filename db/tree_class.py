#handy tree class found at http://stackoverflow.com/questions/2482602/a-general-tree-implementation-in-python
#in June 2013.
#original author, Brett Kromkamp
import uuid
...
class Node:
    ...
    def __init__(self, name, identifier=None, expanded=True):
        self.__identifier = (str(uuid.uuid4()) if identifier is None else
